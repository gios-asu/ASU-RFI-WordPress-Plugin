...
class ASU_RFI_Form_Shortcodes extends Hook {
    ...
    public function asu_rfi_form( $atts, $content = '' ) {
        ...
        ensure_default(
            $atts, 'college_program_code', $this->get_option_attribute_or_default(
                array(
    ...
    /**
     * Function: redirect_with_error( WP_Error $error, String $url)
     *
